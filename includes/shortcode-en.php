 ...
 * @return void
 */
function noniko_dmc_register_en_shortcodes() {

	add_shortcode(
		'noniko_daily_meditation_en',
		'noniko_dmc_render_meditation_en_shortcode'
	);
}

add_action(
	'init',
	'noniko_dmc_register_en_shortcodes'
);
 ...
 * @return string
 */
function noniko_dmc_render_meditation_en_shortcode( $atts ) {
